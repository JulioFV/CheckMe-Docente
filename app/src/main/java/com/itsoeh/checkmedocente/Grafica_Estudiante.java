 ...
 * Use the {@link Grafica_Estudiante#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Grafica_Estudiante extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(paquete != null){
            paquete=this.getArguments();
            idGrupo= paquete.getInt("idEstudiante");
        }

        pieChart = view.findViewById(R.id.frg_grafica_asistencia_estudiante);
    ...
    public void obtenerEstados() {
        ...
        StringRequest solicitud = new StringRequest(Request.Method.POST, API.ESTADOESTU,
            ...
            protected Map<String, String> getParams() {
                ...
                param.put("idEstudiante", idGrupo + "");
     ...
     * @return A new instance of fragment Grafica_Estudiante.
     */
    // TODO: Rename and change types and number of parameters
    public static Grafica_Estudiante newInstance(String param1, String param2) {
        Grafica_Estudiante fragment = new Grafica_Estudiante();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_grafica__estudiante, container, false);
    }
}